...
<body style="background: url('/image/pw.jpg')">
<div class="register">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card transparent">
                <div class="card-header" style="text-align: center;"> <h1 style="color: white;"> DAFTAR AKUN  </h1> 
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right"><span class="fa fa-user"></span> {{ __('Name') }}</label>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <span class="fa fa-user-plus"></span>  {{ __('Register') }}
                                </button>
                                <a href="/">
                                <button type="button" class="btn btn-warning"><span class="fa fa-undo"></span> Kembali</button></a>
                            </div>
                        </div>
                    </form>
                </div>
